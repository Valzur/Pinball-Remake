...
#include "GameObjects/Particles/ParticleEffectsManager.h"
...
namespace Valzuroid {
    namespace Pinball {
        ...
        private:
            ...
            Particles::ParticleEffectsManager vfxManager;
            ...
            float timeLeftOnSplashScreen;

            MainMenuIU mainMenuUI = MainMenuIU(this);

            void InitializeSplashScreen(int seconds);
            void StartAll();
        public:
            ...
            void DrawDrawables();
            void CollisionCheck(double collision_time, GameManager& manager);
