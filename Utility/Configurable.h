    ...
    namespace Pinball {
        namespace Utility {
            ...
            public:
                ...
                //Collision Functions
                Vector2D FlippersCollision(Ball& ball, float collision_time, GameManager& manager);
                Vector2D PopBumpersCollision(Ball& ball, float collision_time, GameManager& manager);
                Vector2D BallsCollision(Ball& ball, float collision_time, GameManager& manager);
                Vector2D WallsCollision(Ball& ball, float collision_time, GameManager& manager);
